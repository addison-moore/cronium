...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "ring-offset-background focus-visible:ring-ring bg-background text-foreground hover:bg-muted hover:text-primary/80 data-[state=active]:bg-primary/10 data-[state=active]:text-primary border-border data-[state=active]:border-primary mb-1 inline-flex items-center justify-center whitespace-nowrap rounded-md border px-2 py-1.5 text-sm font-medium transition-all duration-200 hover:cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:mb-0 data-[state=active]:border-b-4 data-[state=active]:shadow-sm sm:px-3",
      className,
    )}
    {...props}
  />
