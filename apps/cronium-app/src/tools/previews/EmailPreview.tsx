...
export function EmailPreview({
  ...
  const renderBody = () => {
    if (isHtml) {
      ...
      return (
        <div className="border-border relative h-64 w-full overflow-hidden rounded-md border">
          <iframe
            srcDoc={body}
    ...
    return (
      <div className="border-border rounded-md border bg-gray-50 p-4 font-mono text-sm whitespace-pre-wrap dark:bg-gray-900">
        {body}
      </div>
    );
  };
