      ...
      <div className="mx-auto max-w-6xl">
        ...
        <GuideSection title="Getting Started" id="getting-started">
          ...
          <GuideCard
            ...
            href={`/docs/how-to/schedule-events`}
            difficulty="Beginner"
            duration="8 min"
          />
        </GuideSection>
        ...
        <GuideSection title="Server Management" id="server-management">
          <GuideCard
            ...
            href={`/docs/how-to/multiple-servers`}
          ...
          <GuideCard
            ...
            href={`/docs/how-to/secure-access`}
            difficulty="Intermediate"
            duration="25 min"
          />
          ...
          <GuideCard
            ...
            href={`/docs/how-to/server-health`}
            difficulty="Intermediate"
            duration="18 min"
          />
        </GuideSection>
        ...
        <GuideSection title="Event Creation" id="event-creation">
          <GuideCard
            ...
            href={`/docs/how-to/effective-scripts`}
            difficulty="Intermediate"
            duration="30 min"
          />
          ...
          <GuideCard
            ...
            href={`/docs/how-to/environment-variables`}
            difficulty="Beginner"
            duration="12 min"
          />
          ...
          <GuideCard
            ...
            href={`/docs/how-to/error-handling`}
            difficulty="Intermediate"
            duration="22 min"
          />
        </GuideSection>
        ...
        <GuideSection title="Workflow Building" id="workflow-building">
          ...
          <GuideCard
            ...
            href={`/docs/how-to/conditional-logic`}
            difficulty="Advanced"
            duration="28 min"
          ...
          <GuideCard
            ...
            href={`/docs/how-to/parallel-execution`}
            difficulty="Advanced"
            duration="25 min"
          />
        </GuideSection>
        ...
        <GuideSection title="Advanced Topics" id="advanced-topics">
          <GuideCard
            ...
            href={`/docs/how-to/deploy-production`}
            difficulty="Advanced"
            duration="45 min"
          />
          ...
          <GuideCard
            ...
            href={`/docs/how-to/api-integration`}
            difficulty="Advanced"
            duration="40 min"
          />
          ...
          <GuideCard
            ...
            href={`/docs/how-to/backup-recovery`}
            difficulty="Advanced"
            duration="35 min"
          />
        </GuideSection>
