...
import ImprovedToolActionSection from "./ImprovedToolActionSection";
...
import type { ToolActionConfig } from "./ImprovedToolActionSection";
...
export default function ImprovedEventForm({
  initialData,
  isEditing = false,
  eventId,
  onSuccess,
}: ImprovedEventFormProps) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      if (initialData.envVars) {
        if (typeof initialData.envVars === "string") {
          try {
            const envVars = JSON.parse(initialData.envVars) as Array<{
              key: string;
              value: string;
            }>;
        ...
        } else if (Array.isArray(initialData.envVars)) {
          setValue("envVars", initialData.envVars);
        }
      }
