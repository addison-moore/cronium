  ...
  teams: [
    {
      ...
      description: "Organization policy blocks incoming webhooks",
      ...
      solutions: [
        {
          ...
          steps: [
            ...
            "Request approval for incoming webhooks",
            "Provide business justification",
            "Wait for policy update",
          ],
        },
        {
          title: "Use Graph API Instead",
          steps: [
  ...
  notion: [
    {
      ...
      description: "The Notion integration can't access the requested pages",
      category: "permissions",
      solutions: [
        {
          ...
          steps: [
            ...
            "The integration will now have access",
          ],
        },
        {
          title: "Check Integration Capabilities",
          steps: [
            "Go to notion.so/my-integrations",
            "Select your integration",
            "Verify the capabilities are correct",
            "Update if necessary and re-authorize",
          ],
          link: {
