      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section id="overview" className="mb-12">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
            <p>
              Tools in Cronium are communication integrations that enable you to send notifications and messages 
              when events complete. Each tool requires credentials for authentication and supports custom templates 
        ...
        <section id="available-tools" className="mb-12">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none mb-6">
            <p>
              Cronium currently supports three communication tools, each with specific features and use cases 
              for different notification requirements.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      <strong>Use cases:</strong> Error alerts, success notifications, daily reports, system status updates
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                    <p className="text-sm text-green-700 dark:text-green-300">
                      <strong>Use cases:</strong> Team notifications, build status, deployment alerts, automated reports
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                    <p className="text-sm text-purple-700 dark:text-purple-300">
                      <strong>Use cases:</strong> Gaming communities, development teams, server monitoring, bot notifications
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <section id="credentials" className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Managing Credentials</h2>
          
          <div className="prose prose-gray dark:prose-invert max-w-none mb-6">
            <p>
              Credentials are securely stored and encrypted authentication details that allow Cronium to 
              connect to external services. Each tool type has specific credential requirements.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="flex flex-col items-center text-center p-4 border rounded-lg">
                      <div className="w-8 h-8 bg-primary/10 text-primary rounded-full flex items-center justify-center font-bold text-sm mb-2">
                        1
                      </div>
                      <h4 className="font-medium mb-1">Select Tool</h4>
                      <p className="text-xs text-muted-foreground">Choose Email, Slack, or Discord</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4 border rounded-lg">
                      <div className="w-8 h-8 bg-primary/10 text-primary rounded-full flex items-center justify-center font-bold text-sm mb-2">
                        2
                      </div>
                      <h4 className="font-medium mb-1">Add Credentials</h4>
                      <p className="text-xs text-muted-foreground">Click "Add New" button</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4 border rounded-lg">
                      <div className="w-8 h-8 bg-primary/10 text-primary rounded-full flex items-center justify-center font-bold text-sm mb-2">
                        3
                      </div>
                      <h4 className="font-medium mb-1">Fill Details</h4>
                      <p className="text-xs text-muted-foreground">Enter authentication information</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4 border rounded-lg">
                      <div className="w-8 h-8 bg-primary/10 text-primary rounded-full flex items-center justify-center font-bold text-sm mb-2">
                        4
                      </div>
                      <h4 className="font-medium mb-1">Test & Save</h4>
                      <p className="text-xs text-muted-foreground">Validate and store credentials</p>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <section id="templates" className="mb-12">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none mb-6">
            <p>
              Templates define the format and content of messages sent through tools. Each tool type 
              supports specific template formats and features for optimal message presentation.
            </p>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-medium mb-3">Template Creation</h4>
                      <div className="space-y-2 text-sm text-muted-foreground">
                        <div className="flex items-center gap-2">
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-1">Template Documentation</h4>
                        <p className="text-sm text-blue-700 dark:text-blue-300">
                          For detailed information about template syntax, variables, and helpers, see the 
                          <a href={`/${lang}/docs/templates`} className="underline ml-1">Templates documentation</a>.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section id="configuration" className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Tool Configuration</h2>
          
          <div className="prose prose-gray dark:prose-invert max-w-none mb-6">
            <p>
              Each tool has specific configuration requirements and setup procedures. Follow these 
              guides to properly configure authentication for each communication service.
            </p>
          </div>
...
From Name: Cronium Notifications`}
                  ...
                  <div className="p-3 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      <strong>Note:</strong> For Gmail and other providers, use app-specific passwords instead of your regular account password.
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <span>Create a new webhook for your target channel</span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="font-mono bg-muted px-1 rounded">4.</span>
                        <span>Copy the webhook URL for Cronium configuration</span>
                      </div>
                    </div>
                  </div>
                  <div className="p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                    <p className="text-sm text-green-700 dark:text-green-300">
                      <strong>Webhook URL format:</strong> https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                    <p className="text-sm text-purple-700 dark:text-purple-300">
                      <strong>Webhook URL format:</strong> https://discord.com/api/webhooks/123456789/abcdefghijk...
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <section id="tool-manager" className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Using the Tool Manager</h2>
          
          <div className="prose prose-gray dark:prose-invert max-w-none mb-6">
            <p>
              The Tool Manager is located in your user settings and provides a comprehensive interface 
              for managing all your communication tools, credentials, and templates.
            </p>
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Choose between Email, Slack, and Discord</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Switch between Credentials and Templates</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Add, edit, and delete credentials and templates</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-2 border rounded">
                    ...
                    <span className="text-xs text-muted-foreground ml-auto">Create credentials/templates</span>
                  </div>
                  <div className="flex items-center gap-3 p-2 border rounded">
                    <Edit className="h-4 w-4 text-blue-500" />
                    <span className="text-sm font-medium">Edit</span>
                    <span className="text-xs text-muted-foreground ml-auto">Modify existing items</span>
                  </div>
                  <div className="flex items-center gap-3 p-2 border rounded">
                    <TestTube className="h-4 w-4 text-purple-500" />
                    <span className="text-sm font-medium">Test</span>
                    <span className="text-xs text-muted-foreground ml-auto">Validate connections</span>
                  </div>
                  <div className="flex items-center gap-3 p-2 border rounded">
                    <Trash2 className="h-4 w-4 text-red-500" />
                    <span className="text-sm font-medium">Delete</span>
                    <span className="text-xs text-muted-foreground ml-auto">Remove items permanently</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <section id="best-practices" className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-green-600">Security & Management</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Use dedicated service accounts</p>
                      <p className="text-sm text-muted-foreground">Create separate accounts for automation</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Key className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium">Rotate credentials regularly</p>
                      <p className="text-sm text-muted-foreground">Update passwords and tokens periodically</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Verify all credentials work correctly</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Check logs for failed notifications</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-blue-600">Template & Content</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Build template library for consistency</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Name templates clearly for easy selection</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Test Slack/Discord JSON templates thoroughly</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Add event details and execution information</p>
                    </div>
                  </div>
                </div>
              </CardContent>
